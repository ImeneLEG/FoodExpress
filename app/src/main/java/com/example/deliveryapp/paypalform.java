...
public class paypalform extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.paypalform);

        cvvEditText = findViewById(R.id.editTextName4);
        expireEndEditText = findViewById(R.id.editTextName3);
        cardNumberEditText = findViewById(R.id.editTextName2);
